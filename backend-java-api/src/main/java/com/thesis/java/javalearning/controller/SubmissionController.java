...
// import com.thesis.java.javalearning.dto.AsyncSubmitRequest;
// import com.thesis.java.javalearning.dto.AsyncSubmitResponse;
...
// import com.thesis.java.javalearning.service.SseService;
...
//     @Autowired private ExecutionJobRepository executionJobRepository;
//     @Autowired private SseService sseService;

//     @PostMapping("/execute")
//     public ResponseEntity<AsyncSubmitResponse> executeAsync(@RequestBody AsyncSubmitRequest request) {
...
//         ExecutionJob savedJob = executionJobRepository.save(job);
//         codeExecService.executeJobAsync(savedJob);

//         return ResponseEntity.accepted().body(
//                 AsyncSubmitResponse.builder()
//                         .jobId(savedJob.getId())
//                         .status(savedJob.getStatus())
//                         .message("Job accepted into asynchronous queue.")
//                         .build()
//         );
//     }
...
//         emitter.onCompletion(() -> sseService.removeEmitter(jobId));
//         emitter.onTimeout(() -> sseService.removeEmitter(jobId));
//         emitter.onError(ex -> sseService.removeEmitter(jobId));

//         try {
//             emitter.send(SseEmitter.event()
//                     .name("connected")
//                     .data("Listening for execution updates..."));
//         } catch (IOException e) {
...
import com.thesis.java.javalearning.service.SubmissionService;
import org.springframework.http.ResponseEntity;
...
public ResponseEntity<Map<String, String>> submitCode(@RequestBody Map<String, String> payload) {
    try {
        ...
        // Menangkap secara spesifik saat thread pool dan antrean memory penuh
